...
|---|---|---|---|
| [`three-amigos`](skills/three-amigos) | Runs a Three Amigos refinement on a draft story or `CLAUDE.md` increment from BA / Tester / Technician viewpoints; emits a refined value clause, Gherkin scenarios, open questions, and out-of-scope. | Drafting or pre-flighting a user story in Claude chat before implementation begins. | The spec is already refined, or it's a pure implementation task. |
